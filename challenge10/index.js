(function () {
    ...
    */
    function calculator(operation) {
        ...
        return function name(number1, number2) {

            if (typeof number1 !== "number" && typeof number2 !== "number") {
                return false;
            }
            return operation[operation](number, number2);
        }
    ...
    */
    function shpwOperationMessage(operation, nm1, nm2) {

        return "A operação" + nm1 + (operation) + (nm2) + "="
    }
