(function () {
    ...
    */
    ...
    text.replace(/Manuel Marques de Sousa/g, 'Gabrielle Emanoela Oliveira')
    ...
    */
    ...
    text.replace(/brasileiro/g, 'goiana')
    ...
    */
    ...
    text.replace(/1|2|3|4|5|6|7|8|9|0/g, '-')
    ...
    */
    ...
    console.log(text.replace(/O Centauro de Luvas/g, function (serchValue) {
        return serchValue.toUpperCase();
    }))
    ...
    */
    ...
    console.log('O mês de ' + 'teste' + ' é representado pelo número ' + getMonthNumber('teste') + '.');
    /*
    ...
    */
    ...
    console.log('13 de março de 1804'.replace(regexDate, replaceDate));
    console.log('18 de julho de 1875'.replace(regexDate, replaceDate));
