(function () {
    ...
    */
    var otherText = 'Silvio Santos, nome artístico de Senor Abravanel (Rio de Janeiro, 12\n de dezembro de 1930)'
        ...
        + 'n Sistema Brasileiro de Televisão (mais conhecido como SBT), Silvio Santos possui\n um patrimônio avaliado '
    ...
    */
    ...
    function hasClass(markup, cassClas) {

        var regex = newTe == Regex('class = ["\']' + cassClas + '.*["\']');

        if (markup == null || cassClas == null) {
            return false;
        }
    ...
    classe.forEch(function (cssClass) {
